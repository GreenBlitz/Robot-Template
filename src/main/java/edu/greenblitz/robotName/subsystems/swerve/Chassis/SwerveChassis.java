...
public class SwerveChassis extends GBSubsystem implements ISwerveChassis {
	...
	private boolean moduleStalling(SwerveModule module) {
		return module.getLinearCurrent() > MK4iSwerveConstants.FREE_CURRENT - CURRENT_TOLERANCE && module.getLinearCurrent() < CURRENT_TOLERANCE + MK4iSwerveConstants.FREE_CURRENT;
	}
